...
if ($vars['page_ower'] == elgg_get_logged_in_user_entity() && elgg_in_context('resume_edit') )
  echo "<dd class=\"leftspace \"><a href=\"" .$site_url . "resume/view/" . $vars['page_ower']->username . "\")>" . elgg_echo("resume:preview") . "</a><dd>";
