...
<div class="contentWrapper">
    <form action="<?php echo $site_url; ?>action/<?php echo $action ?>"
        ...
        <p><?php echo elgg_echo('resume:work:organisation'); ?><br />
            <?php echo elgg_view('input/text', array('name' => 'organisation','datatype' => 'organisation','id' => 'organisation', 'value' => $vars['entity']->organisation,'class'=>"elgg-input elgg-input-autocomplete")); ?></p>
