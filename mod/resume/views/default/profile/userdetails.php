...
if ($page_owner == elgg_get_logged_in_user_entity()) {
    $title = "<h2><a href=\"" . $CONFIG->wwwroot . "resume/view/" . elgg_get_logged_in_user_entity()->username . "\">" . elgg_echo('resume:my') . "</a></h2>" . "<p class=\"profile_info_edit_buttons\"><a href=\"" . $CONFIG->wwwroot . "resume/view/" . elgg_get_logged_in_user_entity()->username . "\">" . elgg_echo("resume:editportfolio") . "</a></p>" . "" . "<p class=\"profile_info_edit_buttons\"><a href=\"#\"onclick=javascript:window.open(\"" . $CONFIG->wwwroot . "pg/resumesprintversion/" . elgg_get_logged_in_user_entity()->username . "\")>" . elgg_echo("resume:profile:gotoprint") . "</a></p>";
} else {
    $title = "<h2><a href=\"" . $CONFIG->wwwroot . "resume/view/" . $page_owner->username . "\">" . sprintf(elgg_echo('resume:user'), $page_owner->name) . "</a></h2>" . "<p class=\"profile_info_edit_buttons\"><a href=\"#\"onclick=javascript:window.open(\"" . $CONFIG->wwwroot . "pg/resumesprintversion/" . $page_owner->username . "\")>" . elgg_echo("resume:profile:gotoprint") . "</a></p>";
}
...
echo elgg_view_entity_icon($vars['entity'],$iconsize);
        ...
        <td>
            ...
            ?>
                    <p class="profile_info_edit_buttons">
                        <a href="<?php echo $site_url; ?>pg/profile/<?php echo $vars['entity']->username; ?>/edit/"><?php echo elgg_echo("profile:edit"); ?></a>
                    </p>
                <?php
            }
                ?>
