...
elgg_register_event_handler('init','system','lexin_theme_init');

function lexin_theme_init() {
  ...
  date_default_timezone_set("Asia/Shanghai");
	...
	elgg_register_plugin_hook_handler('head', 'page', 'lexin_theme_setup_head');

	elgg_register_js('respond', 'mod/lexin_theme/vendors/js/respond.min.js');
 ...
 */
function lexin_theme_pagesetup() {
 ...
 * @return array
 */
function lexin_theme_setup_head($hook, $type, $data) {
	$data['metas'][] = array(
		'name' => 'viewport',
	...
	$data['links'][] = array(
		...
		'href' => elgg_normalize_url('mod/lexin_theme/graphics/homescreen.png'),
	);
