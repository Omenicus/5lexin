...
if ((elgg_get_context() == "profile") && ($vars['size'] == "large")) {
    ...
    if ((elgg_get_plugin_setting('lastlogin_visibility', 'lastlogin') == "all") || (elgg_get_plugin_setting('lastlogin_visibility', 'lastlogin') == "admin") && (elgg_is_admin_logged_in())) {
        ...
        if ($last_action) {
            ...
            //$contents .=elgg_view_friendly_time( elgg_get_logged_in_user_entity()->last_action).elgg_view_friendly_time( elgg_get_logged_in_user_entity()->last_login);
            //$contents .=date("Y/n/j H:i:s", elgg_get_logged_in_user_entity()->last_action).date("Y/n/j H:i:s", elgg_get_logged_in_user_entity()->last_login);
        } else {
