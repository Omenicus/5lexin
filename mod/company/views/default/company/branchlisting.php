...
if (elgg_get_context() == 'companycontainer') {
    $map = elgg_view('company/maps/company_map', array(
...
<div id="<?php echo $entity->guid ?>" class="search_listing">
    ...
    <div class="search_listing_info">
        <p class="item_address company_address"><?php echo $address ?><br/>
            <?php
            if ($entity->phone) {
                echo elgg_echo('company:branchphone') . ': ' . $entity->phone;
            }
            if ($entity->www) {
                echo elgg_echo('company:branchwebsite') . ': ' . $entity->www;
            }
            if ($entity->services) {
                echo elgg_echo('company:branchspecialties') . ': ' . elgg_view('output/tags', array('tags' => string_to_tag_array($entity->services)));
            }
            ?>
        </p>
    </div>
            ...
            <div class="left padded">
                ...
                if ($parent->canEdit()) {
                    echo elgg_view('output/confirmlink', array(
                        ...
                        'href' => $site_url . 'action/company/delete?company_guid=' . $entity->guid,
