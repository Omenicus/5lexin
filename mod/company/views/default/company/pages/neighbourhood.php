...
$title = elgg_echo('company:neighbourhood');
$header = elgg_view_title($title);

$TabsArray = array();
$TabsArray['all'] = array(
    'id' => 'all_companies',
    'name' => elgg_echo('company:tabs:all'),
    'view' => 'company/maps/global_map',
    'vars' => array(
