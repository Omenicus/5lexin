...
<form action="<?php echo $site_url; ?>action/company/save" method="post" enctype="multipart/form-data" onsubmit="return check_mandatory_fields($(this));">
  <fieldset>
    <?php
    ...
    if( !$new)
    {
      $delete_url = $site_url."action/company/delete?company_guid={$vars['entity']->guid}";
