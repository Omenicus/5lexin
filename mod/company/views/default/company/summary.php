...
$company_logo = elgg_view_entity_icon($company,'large');//elgg_view('profile/icon', array('entity' => $company, 'size' => 'large'));
...
echo elgg_view('company/maps/company_map', array(
    'latitude' => $company->hypelatitude,
    'longitude' => $company->hypelongitude,
