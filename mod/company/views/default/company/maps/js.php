                ...
                '<div style="width:250px;height:100px;padding:10px;">\n\
                    ...
                    <div style="clear:both"></div>\n\
                            ...
                            function getMarkers(map, markers) {
                                ...
                                $.ajax ({
                                    url: '<?php $site_url = elgg_get_site_url();echo elgg_add_action_tokens_to_url($site_url . 'action/company/get_companies') ?>',
                                    type: 'POST',
                            ...
                            function codeAddress(address, company_guid, map) {
                                ...
                                geocoder.geocode({'address': address}, function(results, status) {
                                    if (status == google.maps.GeocoderStatus.OK) {
                                        ...
                                        $.ajax ({
                                            url: '<?php echo elgg_add_action_tokens_to_url($site_url . 'action/company/setlatlng') ?>',
                                            type: 'POST',
                                            dataType: 'html',
                                            data: {
                                                latitude: latlng.lat(),
                            ...
                            function changeLocation(map) {
                                var new_location = prompt('<?php echo elgg_echo('company:nolocationidentified') ?>', '');
