...
echo elgg_view('company/maps/js', $vars);
...
<div id="change_location" class="right"><a href="javascript:void(0)"><?php echo elgg_echo('company:changelocation') ?></a></div><div class="clearfloat"></div>
