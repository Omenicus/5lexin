...
if (count ( $friends ) > 0) {
	...
	foreach ( $friends as $friend ) {
		...
		if ($friend->last_action < time () - 180) {
			echo "<tr>";
			if ($showFriendIcon)
				echo "<td><img width='1' height='1' src='$icon'></td>";
			...
			echo "<img value='0' id='bottom_chat_icon_onoff_".$friend->guid."' src='" . elgg_get_site_url() . "mod/chat/graphics/icons/inactive.png'>";
			$friends_online ++;
		} else {
			echo "<tr>";
			if ($showFriendIcon)
			...
			echo "<img value='1' style='max-width: none;' id='bottom_chat_icon_onoff_" . $friend->guid. "' src='" . elgg_get_site_url() . "mod/chat/graphics/icons/online_s.png'>";
			$friends_online ++;
		}
		echo "</td></tr>";
	}
