...
/*Live Notifications*/
 ...
 .elgg-icon-live_notifications{
    background: url(<?php $site_url = elgg_get_site_url();echo $site_url ?>mod/live_notifications/graphics/icon16.png) no-repeat;
 }

.elgg-icon-live_notifications:hover{
    background: url(<?php echo $site_url ?>mod/live_notifications/graphics/iconh16.png) no-repeat;
 }
