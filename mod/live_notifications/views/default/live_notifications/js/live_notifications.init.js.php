...
$(document).ready(function () {
    ...
    if(elgg.is_logged_in()){
        $("#live_notifications_result").load("<?php $site_url = elgg_get_site_url();echo $site_url; ?>live_notifications/ajax",function(){
       ...
       setInterval(function() {
            ...
            elgg.action('live_notifications/refresh_count', function(response) {
                ...
                if(new_count>num){
                    ...
                    $('#live_notifications_loader').show(); 
                    $("#live_notifications_result").load("<?php echo $site_url; ?>live_notifications/ajax",function(){
                        $('#live_notifications_loader').hide(); // remove the loading gif
